...
from Landau_mod import bell_distribution,bortnik_distribution
#####Landau_mod.golden_distribution###############################################
...
def golden_distribution(vperp,vpar,kpmax,Lmeas):

    fbell=bell_distribution(vperp,vpar)/(10**12)
    fbortnik=bortnik_distribution(vperp,vpar)/(10**12)
